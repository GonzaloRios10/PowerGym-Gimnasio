...
<html>
  ...
  <section class="section main-cliente">
    ...
    <div class="container " style=" border: solid 3px white;margin-top:120px;">
        <div >
            <a name="Enviar" href="../Datos_Personales_Cliente/planilla_bebidas_tabla.php"  class="is-ghost "><b><ion-icon name="arrow-back-circle-sharp" style="font-size:60px;color:#f7f57d;"></ion-icon></b></a>
            <h2 class="info "  >Modificar bebidas</h2><br>
        </div>

     

        <form action="modificar_bebidas.php" method="POST">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-cell="Nombre" class="Personales">
                                <div class="control">
                                    <input type="text" name="nom_bebida" class="input is-rounded" placeholder="Nombre de la comida" value="<?php echo $registro['Nombre']?>" style="color:black;" >
                                </div>     
                            </td>
