      ...
      <section class="section main-clientes" >
        <form action="" method="POST" enctype= "multipart/form-data" >
            <div class="container " style=" border: solid 3px white;;margin-top:80px;">
                <div class="buttons ">
                    <a name="Atras" href="../menu/menu_cliente.php"  class="is-ghost "><b><ion-icon name="arrow-back-circle-sharp" style="font-size:60px;color:#f7f57d;"></ion-icon></b></a>
                </div>
                <h2 class="info" ><span > Formulario de Salud</span></h2><br>
                ...
                <?php
                    if ($resultado) {
                        echo "<a class='button is-warning is-rounded' href='./modificar_formulario_salud.php' >";
                        echo "<span style='color:black;' >Modificar</span>";
                        echo "</a>";  
                    }else{
                        echo "<div class='buttons'>";
                        echo "<button type='submit' name='Enviar' id='Enviar' value ='Enviar' class='button is-warning is-rounded'><b>Enviar</b></button>";
                        echo "</div>";  
                    }
                ?>
            </div>            
