    ...
    <body >
      ...
      <!--  Main -->
        ...
        <div class="container " style=" border: solid 3px white;margin-top:120px;">
            <div >
                <a name="Enviar" href="../Datos_Personales_Cliente/formulario_bebidas.php"  class="is-ghost "><b><ion-icon name="arrow-back-circle-sharp" style="font-size:60px;color:#f7f57d;"></ion-icon></b></a>
                <h2 class="info "  >Planilla de bebidas creadas</h2><br>
                    ...
                    <thead>
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            <td  style="font-size:20px;"> 
                                <a  href="./modificar_bebida_tabla.php?id=<?php echo $row['idalimentos']?>"class="is-ghost "><img src="../imagenes/editar.png" alt=""></a>

                                <a href="#" class="is-ghost delete-bebida" data-id="<?php echo $row['idalimentos']?>"><img src="../imagenes/borrar.png" alt=""></a>
                            </td>
                            <?php
                                }
                            ?>
         ...
         <script>
            $(document).ready(function() {
                $('.delete-bebida').on('click', function(e) {
                    e.preventDefault();

                    var bebidaId = $(this).data('id');
                    var row = $(this).closest('tr');

                    var confirmDelete = confirm('¿Estás seguro de que quieres eliminar esta bebida?');

                    if (confirmDelete) {
                        $.ajax({
                            url: './eliminar_bebida.php?id=' + bebidaId,
                            method: 'GET',
                            success: function(response) {
                                ...
                                if (response === 'success') {
                                    row.remove();
                                    alert('La bebida se ha eliminado correctamente.');
                                } else {
