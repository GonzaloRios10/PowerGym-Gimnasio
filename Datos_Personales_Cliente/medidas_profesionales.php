      ...
      <section class="section main-cliente" >
        <form action="" method="POST"  >
            <div class="container " style=" border: solid 3px white;;margin-top:80px;">
                ...
                <h2 class="info" ><span > Medidas Profesionales</span></h2><br>
                           ...
                           <tr class="Personalestr">
                            ...
                            <tr class="Personalestr">
                                <td class="Personales">
                                    ...
                                    <div class="control">
                                        <input   name="tu_hermana" required  class="input is-rounded"  type="number" placeholder="Ingrese la cantidad de grasa" >
                                    </div>
                                </td>
                                <td class="Personales">
                                    <label class="label">Proteínas:</label>
                                    <div class="control">
                                        <input   name="proteinas" required class="input is-rounded"  type="number" placeholder="Ingrese la cantidad de proteínas" >
                                    </div>
                                </td>
                            ...
                            <tr class="Personalestr">
                                <td class="Personales">
                                    ...
                                    <div class="control">
                                        <input   name="hidratos" required  class="input is-rounded"  type="number" placeholder="Ingrese la cantidad de hidratos" >
                                    </div>
                                </td>
                                <td class="Personales">
                                    <label class="label">Medida:</label>
                                    <div class="control">
                                        <input   name="medida" required class="input is-rounded"  type="number" placeholder="Ingrese la medida" >
                                    </div>
                                </td>
