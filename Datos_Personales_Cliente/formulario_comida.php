      ...
      <!--  Main -->
        ...
        <div class="container " style=" border: solid 3px white;margin-top:120px;">
            <div >
                ...
                <h2 class="info "  >Formulario de Comidas</h2><br>

            </div>

            <div class="table-container animated zoomIn">
   
                <form action="registro_comida_usuario.php" method="POST">
                                ...
                                <tr>
                                    <td data-cell="Comida" style="font-size:20px;">
                                        ...
                                        <div class="control">
                                            <div class="control">
                                                <div class="select" >
                                                <select name="Comidas" id="mySelect">
                                                <?php
                                                ...
                                                <?php
                                                    ...
                                                    $id = $row['idalimentos'];
                                                    $desc_comida = $row['Nombre'];
                                                ?>

                                                    <option value="<?php echo $id?>">
                                                        <?php echo $desc_comida?>    
                                                    </option>
                                                  
                                                <?php
                                                    }
                                                ?>
                                                    <option disabled="true" selected="true" value="0">Seleccione la Comida
                                                    </option>
                                                </select>
                                                </div>
                                            </div>
                                    ...
                                    <td>
                                        <label class="label"><label class="label"><ion-icon name="search-sharp"></ion-icon>Buscar Comida</label></label>
                                        <div class="control">
                                            <!--  -->
               ...
               <p style="color:white;"> <ion-icon name="information-circle"></ion-icon> Si la comida no esta en la lista selecionada puedes dar de alta.</p>
                <a  href="./crear_alta_comida.php"  class="is-ghost "><b><p style="color:#f7f57d;"><img src="../imagenes/comida.png" alt=""> Crear </p></b></a>
                ...
                <a  href="./planilla_comidas_tabla.php"  class="is-ghost "><b><p style="color:#f7f57d;"><img src="../imagenes/editar_comida.png" alt=""> Modificar </p></b></a>
            </div>
        </div> 
        ...
        <script>
            ...
            selectComida.onchange = function() {
                ...
                request.open('GET', 'obtener_cantidad.php?idComida=' + idComidaSeleccionada, true);
