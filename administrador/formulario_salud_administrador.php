      ...
      <section class="section main-login" >
        <form action="" method="POST"  >
            <div class="container " style=" border: solid 3px white;margin-top:80px;">
                ...
                <h2 class="info" ><span > Cuestionario de Salud</span></h2><br>
                        ...
                        <table class="table is-fullwidth" style="border-radius: 15px;">
                           ...
                           <tr class="Personalestr">
                                <td class="Personales">
                                    ...
                                    <div class="control">
                                        <div class="control">
                                            <input class="input is-rounded" type="text" name="lesion" required placeholder="Breve descripción"  >
                                        </div>
                                    </div>
                                </td>
                                <td class="Personales">
                                    ...
                                    <label class="label">En caso afirmativo, descríbalo brevemente:</label>
                                    <div class="control">
                                        <input class="input is-rounded" type="text" required name="lesion_muscular" required placeholder="Breve descripción"  >
                                    </div>
                                </td>
                            </tr>
                            <tr class="Personalestr">
                                <td class="Personales">
                                    ...
                                    <label class="label">En caso afirmativo, descríbalo brevemente:</label>
                                    <div class="control">
                                        <input   name="cardiovascular" required  class="input is-rounded"  type="text" placeholder="Breve descripción" >
                                    </div>
                                </td>                     
                                <td class="Personales">
                            ...
                            <tr class="Personalestr">
                                <td class="Personales">
                                    ...
                                    <div class="control">
                                        <input  required  class="input is-rounded" name="Peso" type="number"  placeholder="Ingrese el Peso" >
                                    </div>
                                </td>
                                <td class="Personales">
