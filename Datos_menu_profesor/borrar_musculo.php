...
<html lang="en">
    ...
    <body>
        ...
        <section class="section main-profesor1">
            <form action="./eliminar_musculo.php" method="post">
            ...
            <h2 >¿Estás seguro de elimiar el registro N°<?php echo $id?>?</h2><br>
              ...
              <div class="buttons" >
                <button class="button is-danger is-medium is-rounded is-responsive" ><b><a href="./crear_musculo.php">Cancelar</b></button></a><br>
